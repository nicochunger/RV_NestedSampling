...
likelihood = bimodal(3, 0.4, 5, 0.4) # Note: this is the log of the likelihood
xmin = 0
xmax = 10
...
# Main result
result = NestedSampling(200, prior, likelihood, 10)
...
print("Run time: {}:{} minutes or {:.3f} seconds".format(int(delta_time/60),int(delta_time%60),delta_time))